...
public class ExpEditDB extends HttpServlet{
      ...
      throws ServletException, IOException {
        ...
        String title = "Insert and View Expense";
		...
		try{
            ...
            st_ins.setInt(1, Integer.parseInt(String.valueOf(no_exp)));
            st_ins.setString(2, request.getParameter("budget_id"));
            st_ins.setString(3, request.getParameter("exp_dets"));
            st_ins.setFloat(4, Float.parseFloat(request.getParameter("amt_spent")));
            st_ins.setString(5, request.getParameter("trip_id"));
