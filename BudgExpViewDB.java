		...
		String trip_id = request.getParameter("tid");
         ...
         try{
			...
			{	
				...
				out.println("<tr><td><input name='ename' class='ename' placeholder='Expense name'></td><td><input name='eamt' class='eamt' planceholder='Amount spent'></td></tr></table><div class='btn' id= 'add-exp-btn' onclick='add_exp("+bid+")'>Add new expense</div></div>");
			}	
            conn.close();
		} 
        catch(Exception e){ 
